                ...
                <Row>
                    ...
                    <Col md={6}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="" value={user.email} disabled />
                        </Form.Group>
                    </Col>
                </Row>
                <Row>
                    ...
                    <Col md={5}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="Nhập tỉnh,thành phố" value={country} onChange={(e) => setCountry(e.target.value)} required />
                        </Form.Group>
                    </Col>
                </Row>
